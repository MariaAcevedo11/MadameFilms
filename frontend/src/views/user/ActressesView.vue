...
function renderChart(): void {
  const canvas = document.getElementById('nationalityChart') as HTMLCanvasElement;
  if (!canvas) return;
    ...
    <div class="max-w-7xl mx-auto space-y-6">
      ...
      <div class="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          class="px-4 py-2 rounded-lg border border-purple-300 bg-white text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
        >
